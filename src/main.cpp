...
itself for Grayscale and Grayscale + alpha images.)",
    ...
    for(size_t i = 0; i < inputFilenames.size(); i++) {
        ...
        ExPop::PixelImage<uint8_t> *scaledSobel =
            ExPop::pixelImageScale<uint8_t>(*sobel, newWidth, newHeight);
        ExPop::PixelImage<uint8_t> *scaledImg =
            ExPop::pixelImageScale<uint8_t, ExPop::pixelValueGetDefaultScalingType<uint8_t>()>(
